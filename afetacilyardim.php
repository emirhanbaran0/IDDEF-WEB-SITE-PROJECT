<?php
    ...
    if(@$_SESSION['key']==1 ){ //Kullanıcının oturumu açık mı kontorlü yapılır
      if(isset($_POST["bagisYap"]))
      {
          ...
          $projeAdi="Afet Acil Yardım Çadırı";
        $bagisTarihi=date("Y-m-d");
          $bagisMiktari=$_POST['miktar'];
          $userId=@$_SESSION['id'];

          //Afet Acil yardım bağış kampanyasına oturumu açık olan kullanıcının bağış yapmasını sağlayan sorgu. 
...
<html >
  <head>
    ...
    <title>IDDEF Afet Acil Yardım</title>
        ...
        <div class="container mt-4">
          <div class="row">
            <div class="col-sm-9">
              ...
              <img src="images/afetcadiri.jpg" class="card-img-top mx-auto" alt="card1" style="width: 50%; height:50%">
              <div class="card-body">
                <h5 class="card-title">Deprem bölgesindeki afetzede kardeşlerimiz için desteklerinizle afet çadırları kuruyoruz</h5>
                <p class="card-text">İDDEF olarak, Kahramanmaraş merkezli 11 ilde yıkım yaşatan depremlerden etkilenen kardeşlerimiz için çadır kurulumuna devam ediyoruz.İnsana Değer Veren Dernekler Federasyonu (İDDEF) olarak, Kahramanmaraş merkezli, Hatay, Gaziantep, Kilis, Osmaniye, Malatya, Adıyaman, Diyarbakır, Şanlıurfa, Elazığ ve Adana’daki 7,7 ve 7,6 büyüklüğündeki depremlerin ardından yaraları sarmak ve deprem bölgelerindeki afetzede kardeşlerimizin acil ihtiyaçlarını karşılamak adına insani yaşam malzemelerini bölgeye ulaştırdığımız gibi barınma ihtiyaçları için AFAD koordinesiyle afet çadırları kuruyoruz. Depremin yaralarını hep birlikte saralım anlayışıyla depremzede bir ailenin barınabileceği bir afet çadırı için destek olabilir, elinizden geldiğinizce yardımda bulunabilirsiniz.</p>
                <h5>Kış Soğuğu Yoksul Halkı Zor Duruma Sokuyor</h5>
                <p>85 milyon tek yürek, tek bilek olarak yaraları sarmaya devam ederken, enkaz altından çıkarılan veya deprem sebebiyle evlerine giremeyen kardeşlerimiz kurulacak olan afet çadırlarında geçici bir süre konaklayacak. Bir ailenin barınabileceği afet çadırının içeriğinde soğuk ve yağmur geçirmez çadır ile beraber halı, battaniye ve elektrikli ısıtıcı bulunuyor.</p>
              </div>
              </div>
            </div>
            <div class="col-sm-3">
