<?php
    ...
    if(@$_SESSION['key']==1){  //Kullanıcının oturumu açık mı kontorlü yapılır
      if(isset($_POST["bagisYap"]))
      {
          ...
          $projeAdi="Yemen Acil Yardım";
        $bagisTarihi=date("Y-m-d");
          $bagisMiktari=$_POST['miktar'];
          $userId=@$_SESSION['id'];
          //Yemen Acil yardım bağış kampanyasına oturumu açık olan kullanıcının bağış yapmasını sağlayan sorgu. 
...
<html >
  <head>
    ...
    <title>IDDEF Yemen Acil Yardım</title>
        ...
        <div class="container mt-4">
          <div class="row">
            <div class="col-sm-9">
              ...
              <img src="images/yemenyardim.png" class="card-img-top mx-auto" alt="card1" style="width: 50%; height:50%">
              <div class="card-body">
                <h5 class="card-title">Yemen Acil Yardım kampanyamızla sen de kardeşlerine yardım elini uzat! Yemen dünyanın en büyük açlık felaketiyle karşı karşıya...</h5>
                <p class="card-text">İnsana Değer Veren Dernekler Federasyonu (İDDEF) olarak iç savaşın içinde açlık ile mücadele eden milyonlarca Yemenli kardeşimize yardımlarınızı ulaştırıyoruz. Orta Doğu’nun en zor durumundaki ülkesinde büyük bir insani kriz yaşanıyor. Yemen’de kardeşlerimiz açlıktan ölüyor. Ülkenin acil yardım çalışmasına ihtiyacı var. Unutmayalım! Bugün Yemen'de her 10 dakikada 1 çocuk hayatını kaybediyor. 1,8 milyon çocuk ise ileri derecede kötü beslenmeye maruz kalıyor.</p>
                <h5>İnsani Yardıma Olan İhtiyaç Her Gün Artıyor</h5>
                <p>Ülkede devam eden çatışmalar milyonlarca kişinin acı çekmesi ve yerinden edilmesine neden oluyor. Şiddet ve karışıklık açlığı, hastalığı getiriyor. Yemenli kardeşlerimizin insani yardıma olan ihtiyaçları her geçen gün artıyor. Sen de gıdaya ihtiyacı olan kardeşlerin için harekete geçebilir, yardımda bulunabilirsin.Birleşmiş Milletler (BM) Dünya Gıda Programı’nın (WFP) hazırladığı raporda yürekleri sızlatan bilgiler yer alıyor. Rapora göre; Yemen dünyanın en büyük açlık kriziyle karşı karşıya. Ülkedeki 18 milyon insan bir sonraki yemeğinin nereden geleceğini bilmeden yaşıyor ve 8 milyon kişi de kıtlığın eşiğine gelmiş durumda. UNICEF tarafından hazırlanan raporda ise Yemen'de 2,2 milyon çocuk akut yetersiz beslenme sorunu yaşıyor. 400 bini ise acilen yardım edilmezse ölüm riski taşıyor.</p>
              </div>
              </div>
            </div>
            <div class="col-sm-3">
