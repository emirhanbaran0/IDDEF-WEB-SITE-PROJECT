<?php
    ...
    if(@$_SESSION['key']==1){  //Kullanıcının oturumu açık mı kontorlü yapılır
      if(isset($_POST["bagisYap"]))
      {
          ...
          $projeAdi="Deprem - Sıcak Yemek";
        $bagisTarihi=date("Y-m-d");
          $bagisMiktari=$_POST['miktar'];
          $userId=@$_SESSION['id'];
          // Deprem Sıcak Yemek yardım bağış kampanyasına oturumu açık olan kullanıcının bağış yapmasını sağlayan sorgu. 
...
<html >
  <head>
    ...
    <title>IDDEF Deprem Sıcak Yemek</title>
        ...
        <div class="container mt-4">
          <div class="row">
            <div class="col-sm-9">
              ...
              <img src="images/deprem.jpeg" class="card-img-top mx-auto" alt="card1" style="width: 50%; height:50%">
              <div class="card-body">
                <h5 class="card-title">Deprem mağduru kardeşlerimiz için her gün sıcak yemek ikramında bulunuyoruz</h5>
                <p class="card-text">İDDEF olarak, gece gündüz demeden depremzede vatandaşlarımızın yanında olmaya devam ediyoruz. Depremin yıkım yaşattığı şehirlerde kurduğumuz aşevlerimizde hayırseverlerimizin desteğiyle pişirdiğimiz günlük 20 bin kişilik yemeklerin ikramını gerçekleştiriyoruz. </p>
        
                <p>İnsana Değer Veren Dernekler Federasyonu (İDDEF) olarak, asrın felaketi olarak nitelenen Kahramanmaraş merkezli, Hatay, Gaziantep, Kilis, Osmaniye, Malatya, Adıyaman, Diyarbakır, Şanlıurfa, Elazığ ve Adana’daki 7,7 ve 7,6 büyüklüğündeki depremlerin ardından kardeşlerimize en temel ihtiyaçları olan çorba, su ve sıcak yemek ikram ediyoruz. Depremin yaralarını hep birlikte saralım anlayışıyla depremzede ailelerimizin 7'den 77'ye yemek ihtiyacını karşılamak için siz de bağışta bulunabilir, benim de bir bir tutam tuzum olsun anlayışıyla gücünüzün yettiğince destek olabilirsiniz. </p>
              </div>
              </div>
            </div>
            <div class="col-sm-3">
